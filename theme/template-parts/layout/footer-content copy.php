...
<?php if ($has_popup): ?>
    ...
    <!-- VERBORGEN container voor Brevo -->
    <div id="sib-container" style="display:none;">
        <div class="sib-form">
            <form id="sib-form"
                method="POST"
                action="https://47872f51.sibforms.com/serve/MUIFAGTyJJDelWZMjFIxahDBE3RnXLyNzUkFGYpd-mOWE6O3uEoYkyxi-SCCtKx7oT02anFMXoO-TTZsNEq1zIAw2sNCV4BhOpF_QChCR28k2wM_ChyZmISqUa2cKSVVwLJSzrrHTNvGN0-kcRFPwx4aNP5SzvtBdm_OQBjbcEuaYB3BXvboLlERr95LYjV9O93L4je9WA1JdCHq"
    ...
    <!-- Popup overlay en content -->
    <div class="popup-overlay" id="popup-overlay"></div>

    <aside class="popup" id="popup" role="dialog" aria-modal="true" aria-labelledby="popup-title">
        <button class="popup__close" id="popup-close" aria-label="Sluit popup">×</button>
        ...
        <footer class="popup__footer">
            <!-- Brevo form wordt hier getoond -->
            <div id="popup-form-placeholder"></div>
        </footer>
    </aside>
...
<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
    <div class="site-footer__container" itemscope itemtype="https://schema.org/Organization">
            ...
            <section class="items__column">
                ...
                <div class="certification-logos">
                    ...
                    <figure itemscope itemtype="https://schema.org/ImageObject">
                        <img src="<?php echo $src; ?>" alt="<?php echo $alt; ?>" loading="lazy" width="auto" height="auto" itemprop="contentUrl" />
        ...
        <div class="site-footer__seo">
            <h6 class="items__column-title">Opzoek naar:</h6>
            <?php wp_nav_menu([
                'theme_location' => 'landingspaginas',
                'container'      => 'nav',
                'menu_class'     => 'landings-menu',
            ]); ?>
        </div>

        <div class="site-footer__copy">
            <a href="https://czabouwbedrijf.marketingsmartheads.dev/wp-content/uploads/2025/11/AV-CZA-Bouwbderijf-2025-pdf.pdf" itemprop="url" target="_blank">Algemene voorwaarden</a>
            <p>Wij werken uitsluitend onder een uitgebreide Construction All Risk (CAR) verzekering. <br/>Zo zijn uw project en onze materialen tijdens de bouw volledig beschermd tegen onvoorziene schade.</p>
        </div>
