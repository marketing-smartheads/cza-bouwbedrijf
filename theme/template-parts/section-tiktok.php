<section class="tips" aria-label="TikTok tips">
    <div class="tips__container">
        ...
        <div class="tips-slider"> <!-- wrapper voor slider + nav -->
                            ...
                            <?php if (!empty($image)) : ?>
                                <figure class="tips-card__image group relative">
                                    <a href="<?= esc_url($link['url']); ?>" target="<?= esc_attr($link['target'] ?: '_blank'); ?>" rel="noopener">
                                        ...
                                        <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-tl-2xl rounded-tr-2xl">
            ...
            <!-- NAVIGATIE OUTSIDE SWIPER -->
            <nav class="slider__navigation" aria-label="TikTok navigatie">
                <button class="nav__button nav__button-prev" data-carousel-prev aria-label="Vorige tip">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
                    </svg>
                </button>
                <button class="nav__button nav__button-next" data-carousel-next aria-label="Volgende tip">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
                    </svg>
                </button>
